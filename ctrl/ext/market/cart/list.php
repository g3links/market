...
$data = [
    ...
    'carthistoryroute' => \model\route::form('ext/market/cart/history.php?idproject={0}&idcart=[idcart]', \model\env::session_idproject()),
...
if ($result->isrole) {
    $data += [
        'updatecartgateroute' => \model\route::form('ext/market/cart/change-status.php?idproject={0}&idcart=[idcart]&idgate=[idgate]', \model\env::session_idproject()),
...
if ($result->isrole & $result->allowedit) {
    $data += [
        'editcartdetailroute' => \model\route::form('ext/market/cart/m_carteditproduct.php?idproject={0}&id=[id]', \model\env::session_idproject()),
        'searchproductsroute' => \model\route::form('ext/market/cart/searchproducts.php?idproject={0}', \model\env::session_idproject()),
        'lbl_newcartdetail' => $lexi['sys020'],
    ];
}
\model\route::render('ext/market/cart/list.twig', $data);
