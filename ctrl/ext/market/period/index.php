...
$data = [
    'loaddataroute' => \model\route::form('ext/market/period/loaddata.php?idproject={0}', \model\env::session_idproject()),
];
\model\route::render('ext/market/period/index.twig', $data);
