...
if($result->isrole) {
    $data += [
        'editfullfilroute' => \model\route::form('ext/market/order/p_editfulfill.php?idproject={0}&id={1}', \model\env::session_idproject(), $idorder),
        'lbl_requiredfull' => $lexi['sys042'],
    ];
}
\model\route::render('ext/market/order/fulfillorder.twig', $data);
